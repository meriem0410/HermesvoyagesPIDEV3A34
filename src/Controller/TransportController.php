...
class TransportController extends AbstractController
{
    ...
    #[Route('/statistics', name: 'app_transport_front_statistics', methods: ['GET'])]
    public function statistics(TransportRepository $transportRepository): Response
{
    $statistics = $transportRepository->getTicketStatistics();

    return $this->render('transport_front/statistics.html.twig', [
