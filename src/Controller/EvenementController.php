...
class EvenementController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try {
                $file->move(
                    $this->getParameter('images_directorys'),
                    $fileName
                );
    ...
    public function detailfront(Evenement $evenement , EvenementRepository $evenementRepository): Response
    {

        return $this->render('evenement/showfront.html.twig', [
            'evenement' => $evenement,
            'prix' => $evenement->getBillet()->getPrix(),
        ]);
    }
