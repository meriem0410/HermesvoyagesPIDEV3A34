...
/* user/admin_new.twig */
class __TwigTemplate_ebb6719e9aa676218aa1cd740021e53f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "user/admin_new.twig"));
        ...
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 1, $this->source); })()), "session", [], "any", false, false, false, 1), "get", ["role"], "method", false, false, false, 1) == "admin")) {
            // line 2
            echo "    ";
            echo twig_include($this->env, $context, "user/new.html.twig");
            echo "
";
        } else {
            // line 4
...
{% endif %}
", "user/admin_new.twig", "C:\\Users\\azizr\\Desktop\\HermesvoyagesPIDEV3A34-main\\templates\\user\\admin_new.twig");
    }
}
