...
class __TwigTemplate_2942b882754404066dccb02ebcb02882 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"fh5co-blog-section\" class=\"fh5co-section-gray\">
    ...
    <div class=\"container\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["evenements"]) || array_key_exists("evenements", $context) ? $context["evenements"] : (function () { throw new RuntimeError('Variable "evenements" does not exist.', 115, $this->source); })()));
...
\t\t\t\t\t\t<a href=\"#\"><img src=\"";
            // line 121
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(twig_get_attribute($this->env, $this->source, $context["evenement"], "image", [], "any", false, false, false, 121)), "html", null, true);
            echo "\"></a>
                    </div>
                    <div class=\"blog-text\">
...
\t\t\t\t\t\t                ";
            // line 125
            if ((twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datedebut", [], "any", false, false, false, 125), "Y-m-d") < twig_date_format_filter($this->env, "now", "Y-m-d"))) {
                // line 126
...
\t\t\t\t\t";
        ...
        ";
            // line 129
            if ((twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datedebut", [], "any", false, false, false, 129), "Y-m-d") > twig_date_format_filter($this->env, "now", "Y-m-d"))) {
                // line 130
                echo "                            <small class=\"position-absolute top-0 end-0 bg-danger text-white rounded py-1 px-3 m-2\">Bientot disponible </small>
\t\t\t\t\t";
            }
            // line 132
            echo "                            <h3><a href=\"#\">Titre: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "titre", [], "any", false, false, false, 132), "html", null, true);
            echo "</a></h3>
                            <span class=\"posted_by\">Date Debut: ";
            // line 133
            ((twig_get_attribute($this->env, $this->source, $context["evenement"], "datedebut", [], "any", false, false, false, 133)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datedebut", [], "any", false, false, false, 133), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</span>
                            <span class=\"posted_by\">Date Fin: ";
            // line 134
            ((twig_get_attribute($this->env, $this->source, $context["evenement"], "datefin", [], "any", false, false, false, 134)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datefin", [], "any", false, false, false, 134), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</span>
                            <span class=\"comment\"><a href=\"\">21<i class=\"icon-bubble2\"></i></a></span>
                            <p>";
            // line 136
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "description", [], "any", false, false, false, 136), "html", null, true);
            echo "</p>
                            <p><a href=\"#\">Lieux: ";
            // line 137
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "lieu", [], "any", false, false, false, 137), "html", null, true);
            echo "</a></p>
                            <div class=\"d-flex justify-content-between\">
                                <a class=\"btn btn-sm btn-primary rounded py-2 px-4\" href=\"";
            // line 139
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("eventfrontdetail", ["id" => twig_get_attribute($this->env, $this->source, $context["evenement"], "id", [], "any", false, false, false, 139)]), "html", null, true);
            echo "\">View détail</a>
                            </div>
                        </div>
                    </div> 
...
";
    ...
    {
        return array (  457 => 304,  450 => 300,  445 => 298,  440 => 296,  436 => 295,  431 => 293,  427 => 292,  422 => 290,  416 => 287,  412 => 286,  407 => 284,  402 => 282,  397 => 280,  261 => 146,  248 => 139,  243 => 137,  239 => 136,  234 => 134,  230 => 133,  225 => 132,  221 => 130,  219 => 129,  216 => 128,  212 => 126,  210 => 125,  203 => 121,  196 => 116,  192 => 115,  154 => 80,  124 => 53,  117 => 49,  112 => 47,  108 => 46,  103 => 44,  98 => 42,  93 => 40,  88 => 38,  83 => 36,  78 => 34,  70 => 29,  40 => 1,);
    }
...
\t\t\t\t\t{% endif %}
                            ...
                            <div class=\"d-flex justify-content-between\">
                                <a class=\"btn btn-sm btn-primary rounded py-2 px-4\" href=\"{{ path('eventfrontdetail', {'id': evenement.id}) }}\">View détail</a>
                            </div>
                        </div>
                    </div> 
                </div>
...
", "evenement/front.html.twig", "C:\\Users\\azizr\\Desktop\\HermesvoyagesPIDEV3A34-main\\HermesvoyagesPIDEV3A34-main\\templates\\evenement\\front.html.twig");
    }
}
