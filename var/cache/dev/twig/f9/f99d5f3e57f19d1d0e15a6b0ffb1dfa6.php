...
/* user/show.html.twig */
class __TwigTemplate_261faf2bed33ca97f7d10aaac1bc99b8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 5
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 5, $this->source); })()), "session", [], "any", false, false, false, 5), "get", ["isBanned"], "method", false, false, false, 5) == 1)) {
            echo " 
...
";
    ...
    {
        return array (  129 => 38,  123 => 35,  115 => 30,  108 => 26,  101 => 22,  94 => 18,  85 => 11,  78 => 7,  73 => 5,  66 => 4,  53 => 3,  36 => 1,);
    }
...
{% endif %}
{% endblock %}
", "user/show.html.twig", "C:\\Users\\azizr\\Desktop\\HermesvoyagesPIDEV3A34-main\\templates\\user\\show.html.twig");
    }
}
