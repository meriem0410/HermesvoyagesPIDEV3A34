...
class __TwigTemplate_3ca404887a0ac9215e474b15ed759c0b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, true, false, 10), "get", ["id"], "method", true, true, false, 10) &&  !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "session", [], "any", false, false, false, 10), "get", ["id"], "method", false, false, false, 10)))) {
            // line 11
            echo "        ";
            echo twig_include($this->env, $context, "status/index.html.twig");
            echo "
    ";
        } else {
            // line 13
        ...
        <div class=\"cont\">
            ...
            echo "
                    ";
            // line 21
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "submit", [], "any", false, false, false, 21), 'widget', ["attr" => ["class" => "submit"]]);
            echo "
                ";
            // line 22
            ...
            <div class=\"sub-cont\">
                ...
                <div class=\"form sign-up\">
                    ...
                    ";
            // line 40
            echo             $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 40, $this->source); })()), 'form_start');
            echo "
                        ";
            // line 41
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 41, $this->source); })()), "username", [], "any", false, false, false, 41), 'row');
            echo "
                        ";
            // line 42
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 42, $this->source); })()), "email", [], "any", false, false, false, 42), 'row');
            echo "
                        ";
            // line 43
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 43, $this->source); })()), "password", [], "any", false, false, false, 43), 'row');
            echo "
                        ";
            // line 44
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 44, $this->source); })()), "submit", [], "any", false, false, false, 44), 'widget', ["attr" => ["class" => "submit"]]);
            echo "
                    ";
            // line 45
            echo             $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formSignup"]) || array_key_exists("formSignup", $context) ? $context["formSignup"] : (function () { throw new RuntimeError('Variable "formSignup" does not exist.', 45, $this->source); })()), 'form_end');
            echo "
                </div>
            </div>
        </div>
    ...
    {
        return array (  153 => 45,  149 => 44,  145 => 43,  141 => 42,  137 => 41,  133 => 40,  113 => 23,  109 => 22,  105 => 21,  101 => 20,  97 => 19,  93 => 18,  86 => 13,  80 => 11,  77 => 10,  70 => 9,  60 => 6,  53 => 5,  36 => 3,);
    }
