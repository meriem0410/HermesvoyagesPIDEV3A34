...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TicketsFrontController' => 'getTicketsFrontControllerService',
            'App\\Controller\\TransportController' => 'getTransportControllerService',
            'App\\Controller\\TransportFrontController' => 'getTransportFrontControllerService',
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eUzo1NOe9y', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'TypedBundle' => 'Symfony\\UX\\Typed\\TypedBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'TypedBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'ux-typed'),
            ...
            'videos_directory' => (\dirname(__DIR__, 4).'/public/Video/'),
            'images_directory' => (\dirname(__DIR__, 4).'/public/Images/'),
            'images_directorys' => (\dirname(__DIR__, 4).'/public/uploads/images'),
            ...
            'karser_recaptcha3.host' => 'www.recaptcha.net',
            'console.command.ids' => [
