...
class getKarserRecaptcha3_Form_TypeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['karser_recaptcha3.form.type'] = new \Karser\Recaptcha3Bundle\Form\Recaptcha3Type($container->getEnv('RECAPTCHA3_KEY'), 'www.recaptcha.net', true);
    }
}
