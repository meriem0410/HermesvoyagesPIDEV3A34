...
class getKarserRecaptcha3_ValidatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = new \ReCaptcha\ReCaptcha($container->getEnv('RECAPTCHA3_SECRET'), new \Karser\Recaptcha3Bundle\RequestMethod\SymfonyHttpClient(($container->privates['http_client.uri_template'] ?? $container->load('getHttpClient_UriTemplateService')), (new \Karser\Recaptcha3Bundle\Services\HostProvider('www.recaptcha.net'))->getVerifyUrl()));
